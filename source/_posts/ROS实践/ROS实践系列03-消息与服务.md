...
###### <br>~ROS基础实践_03~<br>万创鑫诚-ROS_1 系列培训<br><br>──<br><u>日期：2025年10月3日</u><br>**TiKaRa**<br>*ALp_Studio*
...
- **数组类型**（**ROS 1 仅支持固定长度数组**）：  
  **✅ 正确**：`float64 data[10]`（10 个浮点数）  
  **❌ 错误**：`float64[] data`（ROS 1 不支持动态数组）  
  
  > **ROS 2 补充**：ROS 2 支持动态数组，写法为 `float64[] data`。
...
![image-20251003225417929](C:\Users\Tika\Desktop\万创鑫诚\培训\笔记\nKoQEjkrSI3Bltg.png)
